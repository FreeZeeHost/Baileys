...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, {
        ...
        const pollMessage = messages.pollCreationMessage || messages.pollCreationMessageV2 || messages.pollCreationMessageV3 || messages.pollCreationMessageV4 || messages.pollCreationMessageV5
    ...
    const getTypeMessage = (msg) => {
        ...
        if (message.pollCreationMessage || message.pollCreationMessageV2 || message.pollCreationMessageV3 || message.pollCreationMessageV4 || message.pollCreationMessageV5) {
            return 'poll'
