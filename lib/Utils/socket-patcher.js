        ...
        aiRichMessage: async (jid, submessages, options = {}) => {
            ...
            for (const sm of submessages) {
                ...
                switch(sm.messageType) {
                    case 1: // GRID_IMAGE
                        sm.gridImageMetadata.imageUrls.forEach(img => {
                            sections.push({
                                view_model: {
                                    primitive: {
                                        media: { url: img.imageHighResUrl || img.imagePreviewUrl, mime_type: 'image/jpeg' },
                                        imagine_type: 3,
                                        status: { status: 'READY' },
                    ...
                    case 3: // INLINE_IMAGE
                        primitive = {
                            media: { url: sm.imageMetadata.imageUrl.imagePreviewUrl, mime_type: 'image/jpeg' },
