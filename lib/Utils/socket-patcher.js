...
const patchSocket = (sock, options = {}) => {
    // 1. Apply Advanced Features (Fixed Function Calls)
    stealth_mode_1.withStealthMode(sock, options.stealth)
    make_smart_queue_1.withSmartQueue(sock, options.logger || sock.logger)
    make_middleware_1.withMiddleware(sock)
    media_engine_1.withMediaEngine(sock, options.media)
