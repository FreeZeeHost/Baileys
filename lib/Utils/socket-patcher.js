...
exports.patchSocket = (conn) => {
    ...
    conn.msg = {
        ...
        createEvent: (jid, eventData, options = {}) => {
            // eventData: { name, description, location: { lat, lng, name }, startTime, endTime, extraGuestsAllowed }
        ...
        aiRichMessage: async (jid, submessages, options = {}) => {
            ...
            // Helper to prepare media URL (converts Buffer to WhatsApp MMG URL)
            ...
            // Process submessages to resolve media URLs
            ...
            // Generate Unified Response JSON
