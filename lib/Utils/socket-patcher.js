...
const MessageHelpers = {
    ...
    replyQuestion(text, key = this.key, opt = {}) { return this._conn.msg.replyQuestion(this.chat, text, key, { quoted: this, ...opt }); },
    replySurvey(survey, opt = {}) { return this._conn.msg.sendSurvey(this.chat, survey, { quoted: this, ...opt }); },
    replyStatusQuestion(text, opt = {}) { return this._conn.msg.sendStatusQuestion(text, { quoted: this, ...opt }); }
};
