...
const MessageHelpers = {
    ...
    edit(text, options = {}) { return this._conn.msg.editMessage(this.chat, this.key, text, { quoted: this, ...options }); },
    replyEdit(text, options = {}) { return this.edit(text, options); },
    ...
    replyCatalog(businessOwnerJid, title, description, imageOrUrl = null, options = {}) { return this._conn.msg.sendCatalog(this.chat, businessOwnerJid, title, description, imageOrUrl, { quoted: this, ...options }); },
    sendCatalog(businessOwnerJid, title, description, imageOrUrl = null, options = {}) { return this.replyCatalog(businessOwnerJid, title, description, imageOrUrl, options); },
    replyProductList(title, text, footer, buttonText, sections = [], businessOwnerJid = "", options = {}) { return this._conn.msg.sendProductList(this.chat, title, text, footer, buttonText, sections, businessOwnerJid, { quoted: this, ...options }); },
    sendProductList(title, text, footer, buttonText, sections = [], businessOwnerJid = "", options = {}) { return this.replyProductList(title, text, footer, buttonText, sections, businessOwnerJid, options); },
    ...
    replySendQuestion(content, options = {}) { return this._conn.msg.sendQuestion(this.chat, content, { quoted: this, ...options }); },
    sendQuestion(content, options = {}) { return this.replySendQuestion(content, options); },
    replySendQuestionReply(content, options = {}) { return this._conn.msg.sendQuestionReply(this.chat, content, { quoted: this, ...options }); },
    sendQuestionReply(content, options = {}) { return this.replySendQuestionReply(content, options); },
    ...
    replySticker(content, options = {}) { return this._conn.msg.sendSticker(this.chat, content, { quoted: this, ...options }); },
    sendSticker(content, options = {}) { return this.replySticker(content, options); },
    ...
    replyInteractiveButtons(title, text, footer, buttonsList, options = {}) { return this._conn.msg.interactiveButtons(this.chat, title, text, footer, buttonsList, { quoted: this, ...options }); },
    sendInteractiveButtons(title, text, footer, buttonsList, options = {}) { return this.replyInteractiveButtons(title, text, footer, buttonsList, options); },
    replyBotInvoke(text, options = {}) { return this._conn.msg.sendBotInvoke(this.chat, text, { quoted: this, ...options }); },
    sendBotInvoke(text, options = {}) { return this.replyBotInvoke(text, options); },
    replyBotTask(text, options = {}) { return this._conn.msg.sendBotTask(this.chat, text, { quoted: this, ...options }); },
    sendBotTask(text, options = {}) { return this.replyBotTask(text, options); },
    replyChannelForward(content, channelJid, channelName, serverMessageId = 1, options = {}) { return this._conn.msg.sendChannelForward(this.chat, content, channelJid, channelName, serverMessageId, { quoted: this, ...options }); },
    sendChannelForward(content, channelJid, channelName, serverMessageId = 1, options = {}) { return this.replyChannelForward(content, channelJid, channelName, serverMessageId, options); },
    replyBotForwarded(content, options = {}) { return this._conn.msg.sendBotForwardedMessage(this.chat, content, { quoted: this, ...options }); },
    sendBotForwarded(content, options = {}) { return this.replyBotForwarded(content, options); },
    replyEventCover(eventMessageKey, imagePathOrBuffer, options = {}) { return this._conn.msg.sendEventCoverImage(this.chat, eventMessageKey, imagePathOrBuffer, { quoted: this, ...options }); },
    sendEventCover(eventMessageKey, imagePathOrBuffer, options = {}) { return this.replyEventCover(eventMessageKey, imagePathOrBuffer, options); },
    replyGroupMentioned(groupJid, text = "", options = {}) { return this._conn.msg.sendGroupMentionedMessage(this.chat, groupJid, text, { quoted: this, ...options }); },
    sendGroupMentioned(groupJid, text = "", options = {}) { return this.replyGroupMentioned(groupJid, text, options); },
    likeStatus(emoji = "❤️") { return this._conn.msg.likeStatus(this.key, emoji); },
    replyShop(shopId, surface = 3, title = "", text = "", footer = "", options = {}) { return this._conn.msg.sendShopMessage(this.chat, shopId, surface, title, text, footer, { quoted: this, ...options }); },
    sendShop(shopId, surface = 3, title = "", text = "", footer = "", options = {}) { return this.replyShop(shopId, surface, title, text, footer, options); },
    replyCollection(bizJid, collectionId, title = "", text = "", footer = "", options = {}) { return this._conn.msg.sendCollectionMessage(this.chat, bizJid, collectionId, title, text, footer, { quoted: this, ...options }); },
    sendCollection(bizJid, collectionId, title = "", text = "", footer = "", options = {}) { return this.replyCollection(bizJid, collectionId, title, text, footer, options); },
    replyPaymentReceipt(amount, currency = "IDR", noteText = "", requestMessageKey = null, options = {}) { return this._conn.msg.sendPaymentReceipt(this.chat, amount, currency, noteText, requestMessageKey, { quoted: this, ...options }); },
    sendPaymentReceipt(amount, currency = "IDR", noteText = "", requestMessageKey = null, options = {}) { return this.replyPaymentReceipt(amount, currency, noteText, requestMessageKey, options); },
    ...
    sendMediaWithAnnotations(mediaType, pathOrBuffer, annotations = [], options = {}) { return this._conn.msg.sendMediaWithAnnotations(this.chat, mediaType, pathOrBuffer, annotations, { quoted: this, ...options }); },
    replyMediaWithAnnotations(mediaType, pathOrBuffer, annotations = [], options = {}) { return this.sendMediaWithAnnotations(mediaType, pathOrBuffer, annotations, options); },
    sendLimitSharing(sharingLimited, trigger = 1, initiatedByMe = true, options = {}) { return this._conn.msg.sendLimitSharing(this.chat, sharingLimited, trigger, initiatedByMe, { quoted: this, ...options }); },
    replyLimitSharing(sharingLimited, trigger = 1, initiatedByMe = true, options = {}) { return this.sendLimitSharing(sharingLimited, trigger, initiatedByMe, options); },
    sendPollV2(poll, options = {}) { return this._conn.msg.sendPollV2(this.chat, poll, { quoted: this, ...options }); },
    replyPollV2(poll, options = {}) { return this.sendPollV2(poll, options); },
    sendPollV3(poll, options = {}) { return this._conn.msg.sendPollV3(this.chat, poll, { quoted: this, ...options }); },
    replyPollV3(poll, options = {}) { return this.sendPollV3(poll, options); },
    setDisappearingMode(durationSecs, options = {}) { return this._conn.msg.setDisappearingMode(this.chat, durationSecs, { quoted: this, ...options }); },
    replyDisappearingMode(durationSecs, options = {}) { return this.setDisappearingMode(durationSecs, options); },
    sendStyledText(text, font = 0, textColor = null, backgroundColor = null, options = {}) { return this._conn.msg.sendStyledText(this.chat, text, font, textColor, backgroundColor, { quoted: this, ...options }); },
    replyStyledText(text, font = 0, textColor = null, backgroundColor = null, options = {}) { return this.sendStyledText(text, font, textColor, backgroundColor, options); },
    setStatusPrivacy(mode, userJids = []) { return this._conn.msg.setStatusPrivacy(mode, userJids); },
    muteStatus(muted = true) { return this._conn.msg.muteStatus(this.chat, muted); },
    setFavorite(isFavorite = true) { return this._conn.msg.setFavorite(this.chat, isFavorite); },
    lockChat(locked = true) { return this._conn.msg.lockChat(this.chat, locked); },
    editChatNote(content, deleted = false) { return this._conn.msg.editChatNote(this.chat, content, deleted); },
    setLocale(locale) { return this._conn.msg.setLocale(locale); },
    setUnarchiveChats(unarchive = true) { return this._conn.msg.setUnarchiveChats(unarchive); },
    setTimeFormat(is24Hour = true) { return this._conn.msg.setTimeFormat(is24Hour); },
...
exports.patchSocket = (conn) => {
    ...
    conn.readMessages = async (keys) => {
        let targetKeys = keys;
        if (conn.ghostMode) {
            targetKeys = keys.filter(k => vipList.has(jidNormalizedUser(k.remoteJid)));
            if (targetKeys.length === 0) return;
        }
        return originalReadMessages.call(conn, targetKeys);
    };
    ...
    conn.sendMessage = async (jid, content, options = {}) => {
        return taskQueue.push(jid, async () => {
    ...
    const uploadToCatbox = async (buffer, mimeType = "image/jpeg") => {
    ...
    const uploadToUguu = async (buffer, mimeType = "image/jpeg") => {
    ...
    const uploadToPixeldrain = async (buffer, mimeType = "image/jpeg") => {
        let filename = "file.jpg";
        if (mimeType.startsWith("video/")) {
            filename = "file.mp4";
        } else if (mimeType.startsWith("audio/")) {
        ...
        const response = await axios.put(`https://pixeldrain.com/api/file/${filename}`, buffer, {
            headers: {
                "Content-Type": mimeType
            },
            timeout: 10000
    ...
    const uploadAnywhere = async (buffer, mimeType) => {
        ...
        try {
            return await uploadToCatbox(buffer, mimeType);
        } catch (e) {
            console.log("[DEBUG] Catbox fallback failed:", e.message);
            try {
                return await uploadToUguu(buffer, mimeType);
            } catch (e2) {
                console.log("[DEBUG] Uguu fallback failed:", e2.message);
                try {
                    return await uploadToPixeldrain(buffer, mimeType);
                } catch (e3) {
    ...
    conn.msg = {
        ...
        list: async (jid, title, text, footer, buttonText, sections, options = {}) => {
            ...
            if (options.image) {
                const mediaContent = typeof options.image === 'string' ? { url: options.image } : options.image;
                const media = await prepareWAMessageMedia({ image: mediaContent }, { upload: conn.waUploadToServer }).catch(() => null);
                ...
                const mediaContent = typeof options.video === 'string' ? { url: options.video } : options.video;
                const media = await prepareWAMessageMedia({ video: mediaContent }, { upload: conn.waUploadToServer }).catch(() => null);
                ...
                const mediaContent = typeof options.document === 'string' ? { url: options.document } : options.document;
                const media = await prepareWAMessageMedia({ document: mediaContent }, { upload: conn.waUploadToServer }).catch(() => null);
                ...
                header = {
                    hasMediaAttachment: true,
                    locationMessage: {
                        degreesLatitude: options.location.latitude || options.location.degreesLatitude || 0,
                        degreesLongitude: options.location.longitude || options.location.degreesLongitude || 0,
        ...
        carousel: async (jid, cardsList, options = {}) => {
            const preparedCards = await Promise.all((cardsList || []).map(async (card) => {
                if (card.body && !card.buttons && !card.image && !card.video && (card.nativeFlowMessage || card.shopStorefrontMessage)) {
                    return card;
                }
                ...
                if (card.image) {
                    const { prepareWAMessageMedia } = require("./messages");
                    const mediaContent = typeof card.image === 'string' ? { url: card.image } : card.image;
                    const media = await prepareWAMessageMedia({ image: mediaContent }, { upload: conn.waUploadToServer }).catch(() => null);
                    if (media?.imageMessage) {
                        header = {
                            hasMediaAttachment: true,
                    ...
                    const { prepareWAMessageMedia } = require("./messages");
                    const mediaContent = typeof card.video === 'string' ? { url: card.video } : card.video;
                    const media = await prepareWAMessageMedia({ video: mediaContent }, { upload: conn.waUploadToServer }).catch(() => null);
                    if (media?.videoMessage) {
                        header = {
                            hasMediaAttachment: true,
                ...
                const buttons = (card.buttons || []).map(btn => {
                    if (btn.type === 'url') {
                        ...
                        return {
                            ...
                            buttonParamsJson: JSON.stringify({
                                display_text: btn.text || "",
                                phone_number: btn.phoneNumber || btn.phone || ""
                            })
                        };
        ...
        interactiveButtons: async (jid, title, text, footer, buttonsList, options = {}) => {
            const { prepareWAMessageMedia } = require("./messages");
            const nativeFlowButtons = (buttonsList || []).map(btn => {
                if (btn.type === 'url') {
                    return {
                        name: "cta_url",
                        buttonParamsJson: JSON.stringify({
        ...
        sendBotInvoke: (jid, text, options = {}) => {
            return conn.sendMessage(jid, {
                botInvokeMessage: {
                    message: {
                        conversation: text || ""
        ...
        sendChannelForward: (jid, content, channelJid, channelName, serverMessageId = 1, options = {}) => {
            let baseMessage = typeof content === 'string' ? { extendedTextMessage: { text: content } } : content;
            const mtype = Object.keys(baseMessage)[0];
            if (baseMessage[mtype]) {
                baseMessage[mtype].contextInfo = baseMessage[mtype].contextInfo || {};
                baseMessage[mtype].contextInfo.forwardingScore = 1;
                baseMessage[mtype].contextInfo.isForwarded = true;
                baseMessage[mtype].contextInfo.forwardedNewsletterMessageInfo = {
                    newsletterJid: channelJid,
                    newsletterName: channelName,
                    serverMessageId: Number(serverMessageId)
                };
            }
            return conn.sendMessage(jid, baseMessage, options);
        },
        sendBotForwardedMessage: (jid, content, options = {}) => {
            let baseMessage = typeof content === 'string' ? { extendedTextMessage: { text: content } } : content;
            return conn.sendMessage(jid, {
                botForwardedMessage: {
                    message: baseMessage
        ...
        sendEventCoverImage: async (jid, eventMessageKey, imagePathOrBuffer, options = {}) => {
            const { prepareWAMessageMedia } = require("./messages");
            const media = await prepareWAMessageMedia({ image: imagePathOrBuffer }, { upload: conn.waUploadToServer }).catch(() => null);
            if (!media?.imageMessage) throw new Error("Failed to prepare event cover image");
            ...
            return conn.sendMessage(jid, {
                ...
                ...options,
                quoted: { key: eventMessageKey }
            });
        },
        sendGroupMentionedMessage: (jid, groupJid, text = "", options = {}) => {
            return conn.sendMessage(jid, {
                groupMentionedMessage: {
                    message: {
                        extendedTextMessage: {
                            text: text || "Grup disebutkan.",
                            contextInfo: {
        ...
        sendShopMessage: (jid, shopId, surface = 3, title = "", text = "", footer = "", options = {}) => {
            let header = undefined;
            if (title) {
                header = {
                    title: title,
                    ...
                    message: {
                        interactiveMessage: {
                            ...
                            shopStorefrontMessage: {
                                id: shopId,
                                surface: typeof surface === 'string' ? (surface === 'FB' ? 1 : surface === 'IG' ? 2 : 3) : surface,
                                messageVersion: 1
                            }
                        }
                    }
        ...
        sendCollectionMessage: (jid, bizJid, collectionId, title = "", text = "", footer = "", options = {}) => {
            let header = undefined;
            if (title) {
                header = {
                    title: title,
        ...
        // --- 🤖 META AI RICH ENGINE ---
        aiRichMessage: async (jid, submessagesInput, options = {}) => {
            const submessages = cloneContent(submessagesInput);
        ...
        aiThinking: async (jid, description, ...args) => {
            ...
            return conn.msg.aiRichMessage(jid, [{ messageType: 2, messageText: realDescription }], { ...options, fallbackText, botMetadata: { progressIndicatorMetadata: { progressDescription: realDescription, stepsMetadata: mappedSteps } } });
        },
        ...
        aiProgress: (jid, description, steps = [], options = {}) => {
            ...
            if (Array.isArray(description)) {
                ...
                finalSteps = description;
                finalDescription = finalSteps[finalSteps.length - 1] || "Thinking...";
            } else if (typeof description === 'object' && !Array.isArray(description) && steps.length === 0) {
                finalOptions = description;
                finalDescription = "Thinking...";
                finalSteps = [];
            }

            const mappedSteps = finalSteps.map(s => {
                if (typeof s === 'string') {
                    return { statusTitle: s, statusBody: "", status: 2, isReasoning: false, isEnhancedSearch: false };
                }
                return {
                    statusTitle: s.title || s.statusTitle || "",
                    statusBody: s.body || s.statusBody || "",
                    ...
                    isEnhancedSearch: !!(s.isEnhancedSearch)
                };
            });

            return conn.sendMessage(jid, {
                text: finalDescription,
                contextInfo: finalOptions.contextInfo,
                messageContextInfo: {
                    botMetadata: {
                        progressIndicatorMetadata: {
                            progressDescription: finalDescription,
                            stepsMetadata: mappedSteps
                        }
                    }
                }
            }, finalOptions);
        ...
        aiSources: (jid, text, sources = [], options = {}) => {
            let finalText = text;
            ...
            if (Array.isArray(text)) {
                if (typeof sources === 'object' && !Array.isArray(sources)) {
                    finalOptions = sources;
                }
                finalSources = text;
                finalText = "";
            }

            const mappedSources = finalSources.map((s, idx) => ({
                provider: s.provider || 1,
                thumbnailCdnUrl: s.thumbnail || s.thumbnailCdnUrl || "",
                sourceProviderUrl: s.url || s.sourceProviderUrl || "",
                sourceQuery: s.query || s.sourceQuery || "",
                faviconCdnUrl: s.favicon || s.faviconCdnUrl || "",
                citationNumber: s.citationNumber || (idx + 1),
        ...
        sendSurvey: (jid, survey, options = {}) => {
            const buildSurveyMetadata = (s = {}) => {
                ...
                const simonSessionId = s.simonSessionId || generateUUID();
                const tessaSessionId = s.tessaSessionId || generateUUID();
                const simonSurveyId = s.simonSurveyId || String(s.surveyId || randomNumericId(15));
                const requestId = s.requestId || generateUUID();
                const tessaRootId = s.tessaRootId || generateUUID();
                ...
                const invitationCtaUrl = s.invitationCtaUrl || "https://www.whatsapp.com/legal/privacy-policy";
                ...
                const privacyStatementFull = s.privacyStatementFull || "Tanggapan Anda aman dan diatur oleh Kebijakan Privasi WhatsApp.";
                const privacyStatementParts = s.privacyStatementParts && s.privacyStatementParts.length > 0
                    ? s.privacyStatementParts
                    : [
                        {
        ...
        sendPaymentReceipt: (jid, amount, currency = "IDR", noteText = "", requestMessageKey = null, options = {}) => {
            return conn.sendMessage(jid, {
                sendPaymentMessage: {
                    noteMessage: {
                        extendedTextMessage: {
                            text: noteText || `Pembayaran sebesar ${currency} ${amount.toLocaleString()} telah dikirim.`
                        }
                    },
                    requestMessageKey: requestMessageKey || undefined
                }
            }, options);
        },
        ...
        sendCatalog: async (jid, businessOwnerJid, title, description, imageOrUrl = null, options = {}) => {
            let catalogImage = undefined;
            if (imageOrUrl) {
                const { prepareWAMessageMedia } = require("./messages");
                const mediaContent = typeof imageOrUrl === 'string' ? { url: imageOrUrl } : imageOrUrl;
                const media = await prepareWAMessageMedia({ image: mediaContent }, { upload: conn.waUploadToServer }).catch(() => null);
                if (media?.imageMessage) {
                    catalogImage = media.imageMessage;
                }
            }
            return conn.sendMessage(jid, {
                productMessage: {
                    businessOwnerJid: businessOwnerJid || conn.user?.id || conn.user?.jid || "",
                    catalog: {
                        title: title || "",
        ...
        sendProductList: async (jid, title, text, footer, buttonText, sections = [], businessOwnerJid = "", options = {}) => {
            const mappedSections = sections.map(sec => ({
                title: sec.title || "",
        ...
        sendAIReminder: async (jid, text, timestampMs, frequency = 1, options = {}) => {
            ...
            const botMetadata = {
                reminderMetadata: {
                    action: 2, // CREATE
                    name: text,
                    nextTriggerTimestamp: timestampMs > 9999999999 ? Math.floor(timestampMs / 1000) : timestampMs,
                    frequency
                }
            };
            const fullContent = {
        ...
        sendSticker: async (jid, content, options = {}) => {
            let buffer;
            try {
                const { Sticker, StickerTypes } = require('wa-sticker-formatter');
                let input = content.sticker;
                if (typeof input === 'object' && input && input.url) {
                    input = input.url;
                }
                const sticker = new Sticker(input, {
                    pack: content.packname || 'FreeZeeHost Pack',
                ...
                console.log("[DEBUG] wa-sticker-formatter failed, using raw buffer/path:", err.message);
                const input = content.sticker;
                if (Buffer.isBuffer(input)) {
                    buffer = input;
                    ...
                    if (fs.existsSync(input)) {
                        ...
                        throw new Error("Invalid sticker path or formatter failed");
                    }
                } else if (input && input.url) {
                    const axios = require('axios');
                    const res = await axios.get(input.url, { responseType: 'arraybuffer' });
                    buffer = Buffer.from(res.data);
                } else {
                    throw new Error("Invalid sticker input");
                }
            }
            return conn.sendMessage(jid, { sticker: buffer }, options);
        },
        sendMediaWithAnnotations: async (jid, mediaType, pathOrBuffer, annotations = [], options = {}) => {
            const { prepareWAMessageMedia } = require("./messages");
            const mediaObj = {};
            mediaObj[mediaType] = pathOrBuffer;
            ...
            if (!media[key]) throw new Error(`Failed to prepare ${mediaType} message`);
            
            const mappedAnnotations = annotations.map(ann => {
                let polygonVertices = ann.polygonVertices || [
                    { x: 100, y: 100 }, { x: 900, y: 100 }, { x: 900, y: 900 }, { x: 100, y: 900 }
                ];
                let action = {};
                if (ann.action) {
                    if (ann.action.type === 'location') {
                        action.location = {
                            latitude: Number(ann.action.data.latitude) || 0,
                            longitude: Number(ann.action.data.longitude) || 0,
                            name: ann.action.data.name || ""
                        };
                    } else if (ann.action.type === 'link') {
                        action.tapAction = {
                            title: ann.action.data.title || "",
                            tapUrl: ann.action.data.url || ""
                        };
                    } else if (ann.action.type === 'newsletter') {
                        action.newsletter = {
                            newsletterJid: ann.action.data.newsletterJid || "",
                            newsletterName: ann.action.data.newsletterName || "",
                            serverMessageId: Number(ann.action.data.serverMessageId) || 0
                        };
                    }
                }
                return {
                    polygonVertices: polygonVertices.map(v => ({ x: Number(v.x), y: Number(v.y) })),
                    shouldSkipConfirmation: !!ann.shouldSkipConfirmation,
                    ...action
                };
            });

            media[key].interactiveAnnotations = mappedAnnotations;
        ...
        sendLimitSharing: (jid, sharingLimited, trigger = 1, initiatedByMe = true, options = {}) => {
            return conn.sendMessage(jid, {
                limitSharingMessage: {
                    sharingLimited: !!sharingLimited,
                    trigger: Number(trigger) || 1,
                    limitSharingSettingTimestamp: Math.floor(Date.now() / 1000),
                    initiatedByMe: !!initiatedByMe
                }
            }, options);
        },
        sendPollV2: (jid, poll, options = {}) => {
            const pollOptions = poll.options || poll.values || [];
            return conn.sendMessage(jid, {
                pollCreationMessageV2: {
                    name: poll.name || "",
                    options: pollOptions.map(opt => ({ optionName: typeof opt === 'string' ? opt : (opt.optionName || "") })),
                    selectableOptionsCount: Number(poll.selectableOptionsCount || poll.selectableCount) || 1
                }
            }, options);
        },
        sendPollV3: (jid, poll, options = {}) => {
            const pollOptions = poll.options || poll.values || [];
            return conn.sendMessage(jid, {
        ...
        setDisappearingMode: (jid, durationSecs, options = {}) => {
            return conn.sendMessage(jid, { disappearingMessagesInChat: durationSecs }, options);
        },
        sendStyledText: (jid, text, font = 0, textColor = null, backgroundColor = null, options = {}) => {
            return conn.sendMessage(jid, { text }, { font, textColor, backgroundColor, ...options });
        },
        editMessage: (jid, key, text, options = {}) => {
            return conn.sendMessage(jid, { text, edit: key }, options);
        },
        setStatusPrivacy: (mode, userJids = []) => {
            if (typeof conn.appPatch !== 'function') throw new Error("appPatch is not available on socket connection");
            const modeInt = typeof mode === 'string' ? {
                'ALLOW_LIST': 0,
                'DENY_LIST': 1,
                'CONTACTS': 2,
                'CLOSE_FRIENDS': 3
            }[mode.toUpperCase()] : Number(mode);
            return conn.appPatch({
                type: 'regular',
                apiVersion: 1,
                operation: 1, // SET
                index: ['setting_statusPrivacy'],
                syncAction: {
                    statusPrivacy: {
                        mode: isNaN(modeInt) ? 2 : modeInt,
                        userJid: userJids
                    }
                }
            });
        },
        muteStatus: (jid, muted = true) => {
            if (typeof conn.appPatch !== 'function') throw new Error("appPatch is not available on socket connection");
            return conn.appPatch({
                type: 'regular_low',
                apiVersion: 1,
        ...
        setFavorite: (jid, isFavorite = true) => {
            if (typeof conn.appPatch !== 'function') throw new Error("appPatch is not available on socket connection");
            return conn.appPatch({
                type: 'regular_low',
                apiVersion: 1,
                operation: isFavorite ? 1 : 2, // SET or REMOVE
                index: ['favorites', jid],
                syncAction: {
                    favoritesAction: {
                        favorites: isFavorite ? [{ id: jid }] : []
                    }
                }
            });
        },
        lockChat: (jid, locked = true) => {
            if (typeof conn.appPatch !== 'function') throw new Error("appPatch is not available on socket connection");
            return conn.appPatch({
                type: 'regular_high',
                apiVersion: 1,
        ...
        editChatNote: (jid, content, deleted = false) => {
            if (typeof conn.appPatch !== 'function') throw new Error("appPatch is not available on socket connection");
            return conn.appPatch({
                type: 'regular',
                apiVersion: 1,
        ...
        setUnarchiveChats: (unarchive = true) => {
            if (typeof conn.appPatch !== 'function') throw new Error("appPatch is not available on socket connection");
            return conn.appPatch({
                type: 'regular',
                apiVersion: 1,
                ...
                syncAction: {
                    unarchiveChatsSetting: {
                        unarchiveChats: !!unarchive
                    }
                }
            });
        },
        setTimeFormat: (is24Hour = true) => {
            if (typeof conn.appPatch !== 'function') throw new Error("appPatch is not available on socket connection");
            return conn.appPatch({
                type: 'regular',
                apiVersion: 1,
                operation: 1, // SET
                index: ['setting_timeFormat'],
                syncAction: {
                    timeFormatAction: {
                        isTwentyFourHourFormatEnabled: !!is24Hour
                    }
                }
            });
        },
        ...
        sendQuestion: (jid, content, options = {}) => {
            let baseMessage = typeof content === 'string' ? { extendedTextMessage: { text: content } } : content;
            const contentMsg = {
                questionMessage: {
                    message: baseMessage
        ...
        sendQuestionReply: (jid, content, options = {}) => {
            let baseMessage = typeof content === 'string' ? { extendedTextMessage: { text: content } } : content;
            const contentMsg = {
        ...
        sendStatusGroupMention: (content, groupJidOrOptions, options = {}) => {
            let groupJid = "";
            let opt = options;
            if (typeof groupJidOrOptions === 'string') {
                groupJid = groupJidOrOptions;
            } else if (groupJidOrOptions && typeof groupJidOrOptions === 'object') {
                opt = groupJidOrOptions;
                groupJid = opt.groupJid || "";
            }
            let baseMessage = typeof content === 'string' ? { extendedTextMessage: { text: content } } : content;
            const mtype = Object.keys(baseMessage)[0];
            if (baseMessage[mtype]) {
                baseMessage[mtype].contextInfo = baseMessage[mtype].contextInfo || {};
                baseMessage[mtype].contextInfo.isGroupStatus = true;
                if (groupJid) {
                    baseMessage[mtype].contextInfo.groupMentions = baseMessage[mtype].contextInfo.groupMentions || [];
                    if (!baseMessage[mtype].contextInfo.groupMentions.some(g => g.groupJid === groupJid)) {
                        baseMessage[mtype].contextInfo.groupMentions.push({ groupJid, groupSubject: "" });
                    }
                }
            }
            const contentMsg = {
            ...
            return conn.relayMessage('status@broadcast', contentMsg, {
                messageId: opt.messageId || generateMessageID(),
                ...opt
            });
        },
    ...
    conn.smsg = (m) => {
        ...
        if (msg) {
            ...
            if (msg?.botForwardedMessage) msg = msg.botForwardedMessage.message;
            m.mtype = Object.keys(msg)[0];
            m.msg = msg[m.mtype];
        }

        m.text = msg ? (msg.conversation || msg.extendedTextMessage?.text || msg.imageMessage?.caption || msg.videoMessage?.caption || msg.templateButtonReplyMessage?.selectedId || msg.buttonsResponseMessage?.selectedButtonId || msg.listResponseMessage?.singleSelectReply?.selectedRowId || "") : "";
    ...
    // ─── ALIAS: conn.msg.xxx → conn.xxx (akses langsung tanpa .msg) ───────────
    // AI Functions (sudah ada)
    ...
    // ─── Interactive / Native Flow Messaging ────────────────────────────────────
    // Semua fungsi ini sebelumnya hanya ada di conn.msg.xxx, sekarang bisa
    // dipanggil langsung sebagai sock.sendList(), sock.sendCarousel(), dll.
    conn.sendList = conn.msg.list;
    conn.sendCarousel = conn.msg.carousel;
    conn.sendInteractiveButtons = conn.msg.interactiveButtons;
    conn.sendNativeTable = conn.msg.nativeTable;
    conn.sendShopMessage = conn.msg.sendShopMessage;
    conn.sendCollectionMessage = conn.msg.sendCollectionMessage;
    conn.sendBotInvoke = conn.msg.sendBotInvoke;
    conn.sendBotTask = conn.msg.sendBotTask;
    conn.sendChannelForward = conn.msg.sendChannelForward;
    conn.sendBotForwardedMessage = conn.msg.sendBotForwardedMessage;
    conn.sendEventCoverImage = conn.msg.sendEventCoverImage;
    conn.sendGroupMentionedMessage = conn.msg.sendGroupMentionedMessage;
    conn.likeStatus = conn.msg.likeStatus;

    // ─── Payments, Invoices & Orders ────────────────────────────────────────────
    conn.sendPaymentRequest = conn.msg.sendPaymentRequest;
    conn.sendPaymentReceipt = conn.msg.sendPaymentReceipt;
    conn.sendPaymentInvite = conn.msg.sendPaymentInvite;
    ...
    // ─── Poll & Survey ───────────────────────────────────────────────────────────
    conn.sendPollV2 = conn.msg.sendPollV2;
    conn.sendPollV4 = conn.msg.sendPollV4;
    conn.sendPollResultSnapshot = conn.msg.sendPollResultSnapshot;
    conn.sendPollResultSnapshotV3 = conn.msg.sendPollResultSnapshotV3;
    conn.sendQuizPoll = conn.msg.sendQuizPoll;
    conn.sendImagePoll = conn.msg.sendImagePoll;
    conn.sendSurvey = conn.msg.sendSurvey;

    // ─── Media Specials ──────────────────────────────────────────────────────────
    conn.sendVideoNote = conn.msg.sendVideoNote;
    conn.sendLottieSticker = conn.msg.sendLottieSticker;
    conn.sendAiSticker = conn.msg.sendAiSticker;
    conn.sendSticker = conn.msg.sendSticker;
    conn.sendAlbum = conn.msg.sendAlbum;
    conn.sendStyledText = conn.msg.sendStyledText;

    // ─── Events & Calls ──────────────────────────────────────────────────────────
    conn.sendGroupEvent = conn.msg.sendGroupEvent;
    conn.scheduleCall = conn.msg.scheduleCall;
    conn.editScheduledCall = conn.msg.editScheduledCall;
    conn.sendCallLog = conn.msg.sendCallLog;
    conn.bcall = conn.msg.bcall;

    // ─── Newsletter ───────────────────────────────────────────────────────────────
    conn.sendNewsletterAdminInvite = conn.msg.sendNewsletterAdminInvite;
    conn.sendNewsletterFollowerInvite = conn.msg.sendNewsletterFollowerInvite;

    // ─── Status ───────────────────────────────────────────────────────────────────
    conn.sendStatusMusic = conn.msg.sendStatusMusic;
    conn.sendStatusCloseFriends = conn.msg.sendStatusCloseFriends;
    // ─────────────────────────────────────────────────────────────────────────────
    ...
    // Interactive & Native flow aliases
    conn.sendList = conn.msg.list;
    conn.sendCarousel = conn.msg.carousel;
    conn.carousel = conn.msg.carousel;
    conn.sendButtons = conn.msg.buttons;
    conn.buttons = conn.msg.buttons;
    conn.sendInteractiveButtons = conn.msg.interactiveButtons;
    conn.interactiveButtons = conn.msg.interactiveButtons;
    conn.sendNativeTable = conn.msg.nativeTable;
    conn.nativeTable = conn.msg.nativeTable;
    conn.sendBCall = conn.msg.bcall;
    ...
    // New aliases
    conn.sendQuestion = conn.msg.sendQuestion;
    conn.sendQuestionReply = conn.msg.sendQuestionReply;
    ...
    conn.sendMediaWithAnnotations = conn.msg.sendMediaWithAnnotations;
    conn.sendLimitSharing = conn.msg.sendLimitSharing;
    conn.sendPollV2 = conn.msg.sendPollV2;
    conn.sendPollV3 = conn.msg.sendPollV3;
    conn.setDisappearingMode = conn.msg.setDisappearingMode;
    conn.sendStyledText = conn.msg.sendStyledText;
    conn.editMessage = conn.msg.editMessage;
    conn.setStatusPrivacy = conn.msg.setStatusPrivacy;
    conn.muteStatus = conn.msg.muteStatus;
    conn.setFavorite = conn.msg.setFavorite;
    conn.lockChat = conn.msg.lockChat;
    conn.editChatNote = conn.msg.editChatNote;
    conn.setLocale = conn.msg.setLocale;
    conn.setUnarchiveChats = conn.msg.setUnarchiveChats;
    conn.setTimeFormat = conn.msg.setTimeFormat;
    conn.sendBotInvoke = conn.msg.sendBotInvoke;
    conn.sendBotTask = conn.msg.sendBotTask;
    conn.sendChannelForward = conn.msg.sendChannelForward;
    
    // Chat List & Status Likes Convenience
    conn.pinChat = (jid, pin = true) => conn.chatModify({ pin }, jid);
    conn.archiveChat = (jid, archive = true) => conn.chatModify({ archive }, jid);
    conn.muteChat = (jid, muteDuration = 8 * 3600 * 1000) => conn.chatModify({ mute: muteDuration }, jid);
    conn.unmuteChat = (jid) => conn.chatModify({ mute: null }, jid);
    conn.markChatAsRead = (jid, read = true) => conn.chatModify({ markRead: read }, jid);
    conn.likeStatus = conn.msg.likeStatus;
    conn.sendShopMessage = conn.msg.sendShopMessage;
    conn.sendCollectionMessage = conn.msg.sendCollectionMessage;
    ...
    conn.ev.on('messages.upsert', async ({ messages, type }) => {
        ...
        for (const m of messages) {
            ...
            // Only process new/real-time messages for auto-read and command execution
            if (type === 'notify') {
                ...
                if (s.isCommand && commands.has(s.command)) {
                    // Run command asynchronously to prevent blocking the message processing loop
                    commands.get(s.command)(s).catch(err => {
    ...
    conn.ev.on('messages.update', (updates) => {
        for (const update of updates) {
            if (update.update.messageStubType === 1 || update.update.protocolMessage?.type === 0 || update.update.message?.protocolMessage?.type === 0) {
    ...
    const medicInterval = setInterval(() => { 
        ...
        if (diff > 45000 && conn.ws?.isOpen) {
            conn.logger.warn({ diff }, "Medic: connection silent for 45s, closing socket");
            conn.ws.close(); 
        }
    }, 15000);
