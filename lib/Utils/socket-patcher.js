...
exports.patchSocket = (conn) => {
    ...
    conn.msg = {
        ...
        aiLatex: (jid, text, ...args) => {
            ...
            return conn.msg.aiRichMessage(jid, submessages, options);
        },
        ...
        aiThinking: async (jid, description, ...args) => {
            ...
            return conn.msg.aiRichMessage(jid, [{ messageType: 2, messageText: description }], { ...options, botMetadata: { progressIndicatorMetadata: { progressDescription: description, stepsMetadata: mappedSteps } } });
        },
        ...
        aiPrompts: async (jid, text, ...args) => {
            ...
            return conn.msg.aiRichMessage(jid, [{ messageType: 2, messageText: text }], { ...options, botMetadata: { suggestedPromptMetadata: { suggestedPrompts: suggestions.map(s => s.prompt), promptSuggestions: { suggestions: suggestions } } } });
        },
        aiReels: (jid, mainText, ...args) => {
            ...
            return conn.msg.aiRichMessage(jid, [{ messageType: 2, messageText: mainText }, { messageType: 9, contentItemsMetadata: { contentType: 1, itemsMetadata: reelItems } }], { ...options, sources });
        },
