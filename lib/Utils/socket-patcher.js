...
exports.patchSocket = (conn) => {
    ...
    conn.msg = {
        ...
        aiRichMessage: async (jid, submessages, options = {}) => {
            ...
            // Generate Unified Response JSON (Crucial for rendering)
            const sections = submessages.map(sm => {
                ...
                switch(sm.messageType) {
                    case 1: // GRID_IMAGE
                        typeName = "GenAIImageGridPrimitive";
                        primitive = {
                    ...
                    case 2: // TEXT
                        ...
                        break;
                    case 3: // INLINE_IMAGE
                        typeName = "GenAIImageUXPrimitive";
                        primitive = {
                        ...
                        break;
                    case 4: // TABLE
                        typeName = "GenAITableUXPrimitive";
                        primitive = {
                    ...
                    case 5: // CODE
                        ...
                        break;
                    case 6: // DYNAMIC
                        typeName = "GenAIDynamicPrimitive";
                        primitive = {
                        ...
                        break;
                    case 7: // MAP
                        typeName = "GenAIMapUXPrimitive";
                        primitive = {
                            lat: sm.mapMetadata.centerLatitude,
                            lng: sm.mapMetadata.centerLongitude,
                            pins: sm.mapMetadata.annotations.map(a => ({
                                lat: a.latitude,
                                lng: a.longitude,
                                title: a.title,
                                body: a.body
                        ...
                        break;
                    case 8: // LATEX
                        typeName = "GenAILatexUXPrimitive";
                        primitive = {
                    ...
                    case 9: // CAROUSEL/REELS
                        typeName = "GenAIHScrollLayoutViewModel";
                        return {
                            view_model: {
            ...
            // Special case for Thinking/Progress
