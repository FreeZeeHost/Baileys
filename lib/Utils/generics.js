...
const baileysVersion = [2, 3000, 1026924051];
...
const Browsers = {
    ...
    chrome: (browser) => {
        return ['Linux', 'Chrome', '124.0.6367.60']
    },
...
const getPlatformId = (browser) => {
    // Use official PlatformType enum instead of hardcoded numbers to ensure 100% compatibility
    const platformType = WAProto_1.proto.DeviceProps.PlatformType[browser.toUpperCase()]
    return platformType !== undefined ? platformType.toString() : '1' // 1 is CHROME
}
