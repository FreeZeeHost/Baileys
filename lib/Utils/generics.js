...
// Mock stubs for missing complex functions to prevent import errors
...
export const xmppSignedPreKey = () => ({ tag: 'skey', attrs: {} });
...
// ALIAS NAMES FOR INTERNAL COMPATIBILITY
export const aesEncrypt = aesEncryptGCM;
export const aesDecrypt = aesDecryptGCM;
export const hmacSha256_2 = hmacSha256;
export const sha256_2 = sha256;

// UNIVERSAL ALIASES FOR MAXIMUM COMPATIBILITY
