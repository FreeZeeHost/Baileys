...
exports.initAuthCreds = () => {
    ...
    return {
        noiseKey: libsignal.Curve.generateKeyPair(),
        pairingEphemeralKeyPair: libsignal.Curve.generateKeyPair(),
        signedIdentityKey: libsignal.Curve.generateKeyPair(),
        signedPreKey: signedKeyPair(libsignal.Curve.generateKeyPair(), 1),
