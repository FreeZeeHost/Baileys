...
var __importStar = (this && this.__importStar) || function (mod) {
    ...
    var result = {}
    if (mod != null) for (var k in mod) if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) __setModuleDefault(result, mod)
...
const Browsers = {
    ...
    macOS: (browser) => {
        return ['Mac OS', browser, '18.5']
    },
    windows: (browser) => {
        return ['Windows', browser, '10.0.22631']
    },
    linux: (browser) => {
        return ['Linux', browser, '6.5']
    },
    appropriate: (browser) => {
        return ['Ubuntu', browser, '22.04.4']
    },
...
const getPlatformId = (browser) => {
    ...
    return platformType ? platformType.toString() : '49' // Default to Chrome
}
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/freezeehost/Baileys/main/src/Defaults/index.ts';
    try {
