...
import * as historyUtils from './history.js';
export const { getHistoryMsg, downloadHistory, processHistoryMessage } = historyUtils;

import * as linkPreview from './link-preview.js';
export const { getURLInfo } = linkPreview;
