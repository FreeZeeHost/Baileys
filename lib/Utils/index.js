...
__exportStar(require("./stealth-mode"), exports)
__exportStar(require("./make-smart-queue"), exports)
__exportStar(require("./make-middleware"), exports)
__exportStar(require("./media-engine"), exports)
__exportStar(require("./socket-patcher"), exports)
__exportStar(require("./freezee-socket"), exports)
exports.fetchLatestBaileysVersion = async () => ({ version: [2, 3100, 2], isLatest: true });
