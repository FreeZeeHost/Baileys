...
const configureSuccessfulPairing = (stanza, { advSecretKey, signedIdentityKey, signalIdentities }) => {
    ...
    // FIX: Using correct account signature prefix
    ...
    if (!(0, crypto_2.Curve).verify(accountSignatureKey, accountMsg, accountSignature)) {
        throw new boom_1.Boom('Failed to verify account signature');
    }
    
    // FIX: Using correct device signature prefix
