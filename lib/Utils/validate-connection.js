...
const PLATFORM_MAP = {
    ...
    'Ubuntu': WAProto_1.proto.ClientPayload.WebInfo.WebSubPlatform.CHROME,
    'Linux': WAProto_1.proto.ClientPayload.WebInfo.WebSubPlatform.CHROME
}
...
const generateRegistrationNode = ({ registrationId, signedPreKey, signedIdentityKey }, config) => {
    // CRITICAL FIX: WhatsApp strictly expects a 16-byte MD5 hash of the version string
