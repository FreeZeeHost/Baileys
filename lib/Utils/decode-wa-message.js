...
function decodeMessageNode(stanza, meId, meLid) {
    ...
    const participant = stanza.attrs.participant || (stanza.attrs.addressing_mode === "lid" ? stanza.attrs.participant_pn : stanza.attrs.addressing_mode === "pn" ? stanza.attrs.participant : from);
