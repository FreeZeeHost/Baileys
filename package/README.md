...
RyuuBotz.sendMessage(jid, content, options)
```
...
```javascript
// Simple Text
await RyuuBotz.sendMessage(jid, { text: 'Hello!' });
```
...
```javascript
// With Quoted Reply
await RyuuBotz.sendMessage(jid, { text: 'Hello Shiroko!' }, { quoted: message });
```
</details>
...
```javascript
await RyuuBotz.sendAlbumMessage(jid,
  [{
...
```javascript
await RyuuBotz.newsletterFollow("120363421570647022@newsletter")
```
</details>
...
```javascript
await RyuuBotz.newsletterUnfollow("120363421570647022@newsletter")
```
</details>
...
```javascript
await RyuuBotz.newsletterMute("120363421570647022@newsletter")
```
</details>
...
```javascript
await RyuuBotz.newsletterUnmute("120363421570647022@newsletter")
```
</details>
...
```javascript
// Allow all emoji
await RyuuBotz.newsletterReactionMode("120363421570647022@newsletter", "ALL")
```

```javascript
// Allow special emoji (👍, ❤️, 😯, 😢, 🙏)
await RyuuBotz.newsletterReactionMode("120363421570647022@newsletter", "BASIC")
```

```javascript
// No reaction allowed
await RyuuBotz.newsletterReactionMode("120363421570647022@newsletter", "NONE")
```
</details>
...
```javascript
await RyuuBotz.newsletterUpdateDescription("120363421570647022@newsletter", "News description here!")
```
</details>
...
```javascript
await RyuuBotz.newsletterUpdateName("120363421570647022@newsletter", "New newsletter name!")
```
</details>
...
```javascript
// Change
await RyuuBotz.newsletterUpdatePicture("120363421570647022@newsletter", { url: 'https://example.com/image.jpg' })
```

```javascript
// Remove
await RyuuBotz.newsletterRemovePicture("120363421570647022@newsletter")
```
</details>
...
```javascript
const newsletter = await RyuuBotz.newsletterCreate("Here is name newsletter!", "Here is description!", { url: 'https://example.com/image.jpg' })
...
```javascript
const list_newsletter = await RyuuBotz.newsletterFetchAllParticipating()
...
```javascript
await RyuuBotz.newsletterChangeOwner("120363421570647022@newsletter", "123@lid")
```
</details>
...
```javascript
await RyuuBotz.newsletterDemote("120363421570647022@newsletter", "123@lid")
```
</details>
...
```javascript
await RyuuBotz.newsletterReactMessage("120363421570647022@newsletter", "12", "🦖")
```
</details>
...
```javascript
const group = await RyuuBotz.groupCreate("New Group Title", ["123@s.whatsapp.net", "456@s.whatsapp.net"]);
...
await RyuuBotz.groupSettingUpdate(jid, 'announcement')
```

```javascript
// allow everyone to send messages
await RyuuBotz.groupSettingUpdate(jid, 'not_announcement')
```

```javascript
// allow everyone to modify the group's settings -- like display picture etc.
await RyuuBotz.groupSettingUpdate(jid, 'unlocked')
```

```javascript
// only allow admins to modify the group's settings
await RyuuBotz.groupSettingUpdate(jid, 'locked')
```
</details>
...
```javascript
// add member
await RyuuBotz.groupParticipantsUpdate(jid, ['123@s.whatsapp.net', '456@s.whatsapp.net'], 'add')

// remove member
await RyuuBotz.groupParticipantsUpdate(jid, ['123@s.whatsapp.net', '456@s.whatsapp.net'], 'remove')

// promote member (admins)
await RyuuBotz.groupParticipantsUpdate(jid, ['123@s.whatsapp.net', '456@s.whatsapp.net'], 'promote')

// demote member (unadmins)
await RyuuBotz.groupParticipantsUpdate(jid, ['123@s.whatsapp.net', '456@s.whatsapp.net'], 'demote')
```
</details>
...
```javascript
await RyuuBotz.groupUpdateSubject(jid, 'New Subject Title!')
```
</details>
...
```javascript
await RyuuBotz.groupUpdateDescription(jid, 'New Description!')
```
</details>
...
```javascript
const code = await RyuuBotz.groupRevokeInvite(jid)
...
```javascript
const response = await RyuuBotz.groupGetInviteInfo(code)
...
```javascript
const metadata = await RyuuBotz.groupMetadata(jid) 
...
```javascript
const response = await RyuuBotz.groupAcceptInviteV4(jid, groupInviteMessage)
console.log('joined to: ' + response)
```
</details>
...
```javascript
const response = await RyuuBotz.groupRequestParticipantsList(jid)
...
```javascript
// Approve
const response = await RyuuBotz.groupRequestParticipantsUpdate(jid, ['123@s.whatsapp.net', '456@s.whatsapp.net'], 'approve')
```

```javascript
// Reject
const response = await RyuuBotz.groupRequestParticipantsUpdate(jid, ['123@s.whatsapp.net', '456@s.whatsapp.net'], 'reject')
```
</details>
...
```javascript
const response = await RyuuBotz.groupFetchAllParticipating()
console.log(response)
```
</details>
...
```javascript
await RyuuBotz.groupToggleEphemeral(jid, 86400)
```
</details>
...
```javascript
// Everyone Member
await RyuuBotz.groupMemberAddMode(jid, 'all_member_add')
```

```javascript
// Only Admin
await RyuuBotz.groupMemberAddMode(jid, 'admin_add')
```
</details>
...
```javascript
// Change
await RyuuBotz.updateProfilePicture(jid, { url: 'https://example.com/image.jpg' })
```

```javascript
// Remove
await RyuuBotz.removeProfilePicture(jid)
```
</details>
...
```javascript
// Block
await RyuuBotz.updateBlockStatus(jid, 'block');
```

```javascript
// Unblock
await RyuuBotz.updateBlockStatus(jid, 'unblock');
```
</details>
...
```javascript
const privacySettings = await RyuuBotz.fetchPrivacySettings(true)
...
```javascript
const response = await RyuuBotz.fetchBlocklist()
console.log(response)
```
</details>
...
```javascript
// Everyone
await RyuuBotz.updateLastSeenPrivacy("all")
```

```javascript
// Contacts
await RyuuBotz.updateLastSeenPrivacy("contacts")
```

```javascript
// Contacts Blacklist
await RyuuBotz.updateLastSeenPrivacy("contact_blacklist")
```

```javascript
// Hide
await RyuuBotz.updateLastSeenPrivacy("none")
```
</details>
...
```javascript
// Everyone
await RyuuBotz.updateOnlinePrivacy("all")
```

```javascript
// Match last seen
await RyuuBotz.updateOnlinePrivacy("match_last_seen")
```
</details>
...
```javascript
// Everyone
await RyuuBotz.updateProfilePicturePrivacy("all")
```

```javascript
// Contacts
await RyuuBotz.updateProfilePicturePrivacy("contacts")
```

```javascript
// Contacts Blacklist
await RyuuBotz.updateProfilePicturePrivacy("contact_blacklist")
```

```javascript
// Hide
await RyuuBotz.updateProfilePicturePrivacy("none")
```
</details>
...
```javascript
// Everyone
await RyuuBotz.updateStatusPrivacy("all")
```

```javascript
// Contacts
await RyuuBotz.updateStatusPrivacy("contacts")
```

```javascript
// Contacts Blacklist
await RyuuBotz.updateStatusPrivacy("contact_blacklist")
```

```javascript
// Hide
await RyuuBotz.updateStatusPrivacy("none")
```
</details>
...
```javascript
// Show
await RyuuBotz.updateReadReceiptsPrivacy("all")
```

```javascript
// Hide
await RyuuBotz.updateReadReceiptsPrivacy("none")
```
</details>
...
```javascript
// Everyone
await RyuuBotz.updateGroupsAddPrivacy("all")
```

```javascript
// Contacts
await RyuuBotz.updateGroupsAddPrivacy("contacts")
```

```javascript
// Contacts Blacklist
await RyuuBotz.updateGroupsAddPrivacy("contact_blacklist")
```
</details>
...
```javascript
await RyuuBotz.updateDefaultDisappearingMode(86400)
```
</details>
...
```javascript
const RyuuBotz = makeWASocket({ logger: { level: 'debug' } });
```
</details>
...
```javascript
RyuuBotz.ws.on('CB:presence', (json) => console.log('Sockets update:', json));
...
RyuuBotz.ws.on('CB:edge_routing,id:abcd,routing_info', (node) => console.log('Sockets update:', node));
```
</details>
